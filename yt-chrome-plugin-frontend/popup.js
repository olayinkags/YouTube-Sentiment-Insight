...
document.getElementById("output").textContent = "Popup.js is working!";

document.addEventListener("DOMContentLoaded", async () => {
  const outputDiv = document.getElementById("output");
  const API_KEY = 'AIzaSyAmkfgrTtFNh2lawNWZHI_XsZA9TyDcrsw';  // Replace with your actual YouTube Data API key
  // const API_URL = 'http://ec2-3-253-113-244.eu-west-1.compute.amazonaws.com:5000/';   
